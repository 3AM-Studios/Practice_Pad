...
class SheetMusicMetrics {
  ...
  List<MeasureMetrics> get measuresMetricses => _measuresMetricses;
  ...
  List<MeasureMetrics> get _measuresMetricses {
    ...
    for (final measure in measures) {
      ...
      final measureMetrics =
          MeasureMetrics(symbols, metadata, isNewLine: measure.isNewLine, chordSymbols: measure.allChordSymbols);
