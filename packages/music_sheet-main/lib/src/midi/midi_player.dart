...
// import 'package:flutter_midi/flutter_midi.dart'; // Commented out to avoid conflicts
import 'package:music_sheet/src/measure/measure.dart';
import 'package:music_sheet/src/midi/soundfont_types.dart';
...
import 'package:music_sheet/src/music_objects/rest/rest.dart';

// Stub implementation of FlutterMidi to avoid plugin conflicts
class _FlutterMidiStub {
  Future<void> prepare({required ByteData sf2}) async {
    // Stub implementation - does nothing
    if (kDebugMode) {
      print('MidiPlayer: prepare() called (stub implementation)');
    }
  }
  
  void playMidiNote({required int midi}) {
    // Stub implementation - does nothing
    if (kDebugMode) {
      print('MidiPlayer: playMidiNote($midi) called (stub implementation)');
    }
  }
}
...
class MidiPlayer extends ChangeNotifier {
  ...
  final _FlutterMidiStub _flutterMidi;
