...
class _SymbolEditorDialogState extends State<SymbolEditorDialog> {
  ...
  void initState() {
    super.initState();
    if (widget.initialNote != null && widget.initialNote is Note) {
      _selectedAccidental = (widget.initialNote as Note).accidental;
      _selectedDuration = (widget.initialNote as Note).noteDuration;
    }
  }
