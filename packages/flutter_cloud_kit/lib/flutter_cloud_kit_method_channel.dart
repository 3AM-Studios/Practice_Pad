...
class MethodChannelFlutterCloudKit extends FlutterCloudKitPlatform {
  ...
  Future<void> saveRecordWithAssets(
    ...
    var args = {
      ...
      'recordType': recordType,
      'record': record,
      'assets': assets.map((key, value) => MapEntry(key, value.toMap())),
    };
    if (containerId != null) {
      args['containerId'] = containerId;
    }
    ...
    await methodChannel.invokeMethod('saveRecordWithAssets', args);
  }
  ...
  Future<String?> downloadAsset({
    ...
    try {
      final result = await methodChannel.invokeMethod('downloadAsset', args);
      return result as String?;
    } catch (e) {
      // Return null on any error to allow graceful handling
      return null;
    }
  }
}
